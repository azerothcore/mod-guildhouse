...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
  ...
  (30, 8719, 16242.0, 16240.3, 22.9311, 1.52061, 'Alliance Auctioneer'),
  (31, 9856, 16245.0, 16243.3, 22.9315, 1.52061, 'Horde Auctioneer'),
  ...
  (54, 9858, 16238.2, 16236.5, 22.9306, 1.55386, 'Neutral Auctioneer'),
