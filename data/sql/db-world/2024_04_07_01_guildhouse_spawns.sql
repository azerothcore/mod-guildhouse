...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
  ...
  (30, 8719, 16240.285, 16292.662, 22.93155, 1.5, 'Auctioneer Kresky'),
  (31, 9856, 16237.11, 16292.994, 22.92994, 1.5, 'Auctioneer Grimful'),
  ...
  (35, 500000, 16232.9, 16264.1, 13.55570, 3.028813, 'Stormwind Portal'),
  (36, 500001, 16232.8, 16257.1, 13.93456, 3.028813, 'Darnassus Portal'),
  (37, 500002, 16231.3, 16254.2, 13.65647, 3.028813, 'Exodar Portal'),
  (38, 500003, 16233.4, 16260.6, 13.84770, 3.028813, 'Ironforge Portal'),
  (39, 500004, 16232.9, 16264.1, 13.55570, 3.028813, 'Orgrimmar Portal'),
  (40, 500005, 16231.3, 16254.2, 13.65647, 3.028813, 'Silvermoon Portal'),
  (41, 500006, 16233.4, 16260.6, 13.84770, 3.028813, 'Thunder Bluff Portal'),
  (42, 500007, 16232.8, 16257.1, 13.93456, 3.028813, 'Undercity Portal'),
  (43, 500008, 16211.1, 16266.9, 13.7458, 5.6724, 'Shattrath Portal'),
  (44, 500009, 16213.9, 16270.5, 13.1378, 5.4996, 'Dalaran Portal'),
  ...
  (54, 9858, 16241.486, 16293.587, 22.491693, 1.5, 'Auctioneer Fitch'),
