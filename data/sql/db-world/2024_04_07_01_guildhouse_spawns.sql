...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
  ...
  (30, 8719, 16250.0, 16291.6, 22.9311, 1.52061, 'Auctioneer Kresky'),
  (31, 9856, 16250.0, 16291.6, 22.9311, 1.52061, 'Auctioneer Grimful'),
  ...
  (54, 9858, 16250.0, 16291.6, 22.9311, 1.52061, 'Auctioneer Fitch'),
