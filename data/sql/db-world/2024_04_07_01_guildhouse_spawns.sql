...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
  ...
  (10, 500032, 16220.1, 16287.7, 13.1753, 6.18533, 'Innkeeper'),
  ...
  (30, 8719, 16242.0, 16291.6, 22.9311, 1.52061, 'Alliance Auctioneer'),
  (31, 9856, 16245.0, 16291.4, 22.9315, 1.52061, 'Horde Auctioneer'),
