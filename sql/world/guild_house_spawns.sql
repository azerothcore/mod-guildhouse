...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
	...
	(10, 190022, 16224.1, 16284.2, 13.1755, 4.65225, 'Inkeeper'),
	(11, 30605, 16238.2, 16291.8, 22.9306, 1.55386, 'Banker'),
	(12, 190025, 16252.3, 16284.9, 20.9324, 1.79537, 'Death Knight Trainer'),
	...
	(49, 190024, 16225.8, 16299.3, 20.852, 6.23097, 'Food & Drink Vendor'),
    ...
    (53, 190023, 16242.8, 16302.1, 13.174, 4.6153, 'Ammo & Repair Vendor'),
