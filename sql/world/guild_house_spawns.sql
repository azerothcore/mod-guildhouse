...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
	...
	(12, 500035, 16252.3, 16284.9, 20.9324, 1.79537, 'Death Knight Trainer'),
	...
	(47, 28692, 16230.2, 16316.5, 20.8455, 4.64365, 'Trade Supplies'),
	(48, 28776, 16236.3, 16316.1, 20.8454, 4.64365, 'Tabard Vendor'),
	(49, 500034, 16225.8, 16299.3, 20.852, 6.23097, 'Food & Drink Vendor'),
    (50, 6491, 16319.937, 16242.404, 24.4747, 2.206830, 'Spirit Healer'),
    (51, 191028, 16255.5, 16304.9, 20.9785, 2.97516, 'Barber Chair (Object)'),
    (52, 29636, 16233.5, 16316.1, 20.8455, 4.64365, 'Reagent Vendor'),
