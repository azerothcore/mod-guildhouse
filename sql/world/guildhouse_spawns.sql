...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
	...
	(18, 18753, 16227.5, 16292.3, 13.1839, 1.49691, '<unused>'),
	(19, 28702, 16231.6, 16301, 13.1757, 3.07372, 'Inscription Trainer'),
	(20, 28700, 16231.2, 16295, 13.1761, 3.06574, 'Leatherworking Trainer'),
	(21, 28696, 16228.9, 16304.7, 13.1819, 4.64831, 'Skinning Trainer'),
	(22, 28703, 16218.1, 16281.8, 13.1756, 6.1975, 'Alchemy Trainer'),
	(23, 28704, 16218.3, 16284.3, 13.1756, 6.1975, 'Herbalism Trainer'),
	...
	(33, 223742, 16257.6, 16293.0, 13.17508, 2.989519, 'Stove (Object)'),
	(34, 500000, 16232.9, 16264.1, 13.55570, 3.028813, 'Portal: Stormwind (Object)'),
	(35, 500001, 16232.8, 16257.1, 13.93456, 3.028813, 'Portal: Darnassus (Object)'),
	(36, 500002, 16231.3, 16254.2, 13.65647, 3.028813, 'Portal: Exodar (Object)'),
	(37, 500003, 16233.4, 16260.6, 13.84770, 3.028813, 'Portal: Ironforge (Object)'),
	(38, 500004, 16232.9, 16264.1, 13.55570, 3.028813, 'Portal: Orgrimmar (Object)'),
	(39, 500005, 16231.3, 16254.2, 13.65647, 3.028813, 'Portal: Silvermoon (Object)'),
	(40, 500006, 16233.4, 16260.6, 13.84770, 3.028813, 'Portal: Thunder Bluff (Object)'),
	(41, 500007, 16232.8, 16257.1, 13.93456, 3.028813, 'Portal: Undercity (Object)'),
    (42, 500008, 16211.1, 16266.9, 13.7458, 5.6724, 'Portal: Shattrath (Object)'),
	(43, 500009, 16213.9, 16270.5, 13.1378, 5.4996, 'Portal: Dalaran (Object)'),
	(44, 187293, 16230.5, 16283.5, 13.9061, 3, 'Guild Vault (Object)'),
    ...
    (48, 6491, 16319.937, 16242.404, 24.4747, 2.206830, 'Spirit Healer'),
    (49, 191028, 16255.5, 16304.9, 20.9785, 2.97516, 'Barber Chair (Object)'),
    (50, 29636, 16233.2, 16315.9, 20.8454, 4.64365, 'Reagent Vendor'),
    (51, 29493, 16229.1, 16286.4, 13.176, 3.03831, 'Ammo & Repair Vendor'),
    (52, 28690, 16226.97, 16267.9, 13.15, 4.6533, 'Stable Master'),
	(53, 9858, 16238.2, 16291.8, 22.9306, 1.55386, 'Neutral Auctioneer'),
	(54, 2622, 16242.8, 16302.1, 13.176, 4.55570, 'Poisons Vendor');
	(55, 1111, 16242.8, 16302.1, 13.176, 4.55570, '<unused>');
